...
Le [filtrage](6_filtering.ipynb) est un procédé pour se sortir au maximum de l'incertitude connaissant des a priori comme des hypothèses sur l'incertitude elle-même.

On sait où nous sommes maintenant. Quand on sait où aller, on peut maintenant planifier sa trajectoire. C'est ce que l'on attend de la [recherche de chemin](7_path_planning.ipynb).
